...
- Keep raw audit output in ignored `.superpowers/sdd/`. Track only reviewed
  conclusions and executable plans under `docs/`.
...
- Create tracked ledger:
  `docs/specs/260717-ponytail-reduction-ledger.md`
...
```bash
git add docs/specs/260717-ponytail-reduction-ledger.md \
...
- Move completed tracked records to a dated `docs/archive/`
