...
```sh
mkdir -p docs/archive/2026-07-14-postgresql-credential-foundation
git mv \
  docs/plans/260714-postgresql-credential-foundation-implementation-plan.md \
  docs/archive/2026-07-14-postgresql-credential-foundation/
```

Create
`docs/archive/2026-07-14-postgresql-credential-foundation/260714-postgresql-credential-foundation-verification.md`
...
- remove the Slice 1 plan from `docs/README.md` Active Work;
...
`docs/specs/260713-alpha-launch-human-blocked-steps.md`. Do not
