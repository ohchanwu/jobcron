...
- Modify: `deploy/production/HUMAN_DEPLOY_GUIDE.md`
- Modify:
  `docs/specs/260719-terraform-aws-foundation-and-cloudflare-ingress-automation.md`
- Modify: `docs/README.md`
- Move on completion: `docs/specs/260715-multi-user-account-expansion.md`
- Move on completion: `docs/plans/260722-multi-user-account-expansion.md`
...
```text
docs/archive/2026-07-22-multi-user-account-expansion/
```

Update `docs/README.md` so neither remains under Active Work and both are linked under
...
git add README.md README.ko.md docs/architecture.md deploy/production/README.md \
  ...
  docs/specs/260719-terraform-aws-foundation-and-cloudflare-ingress-automation.md \
  docs/README.md docs/archive/2026-07-22-multi-user-account-expansion
