...
- Follow the approved
  [contextual dealbreaker specification](260718-stage-1-contextual-dealbreaker-validation-and-exclusion-evidence.md).
...
- [x] **Step 0: Record the exact implementation base**
...
- [x] **Step 1: Write failing extraction-evidence tests**
...
- [x] **Step 2: Write failing version-partition tests**
...
- [x] **Step 4: Implement the minimal extraction and version contracts**
...
- [x] **Step 5: Update provider and stub fixtures, then run the package**
...
- [x] **Step 1: Write failing parser and citation-gate tests**
...
- [x] **Step 4: Wire the HTTP provider and stub**
...
- [x] **Step 5: Run package, race, and injection tests**
...
- [x] **Step 1: Write the migration and isolation tests first**
...
- [x] **Step 2: Add the PostgreSQL migration**
...
- [x] **Step 3: Add the storage row and methods**
...
- [x] **Step 4: Update extraction storage and importer mapping**
...
- [x] **Step 5: Run PostgreSQL storage and importer tests**
...
- [x] **Step 1: Write failing candidate and fallback tests**
...
- [x] **Step 2: Write failing structured-reason and compatibility tests**
...
- [x] **Step 3: Implement candidate identity and collection**
...
- [x] **Step 4: Add the scoring reason contract**
...
- [x] **Step 5: Add the normalized profile hash**
...
- [x] **Step 6: Run scoring and profile tests**
...
- [x] **Step 1: Write failing runtime-version and user-isolation tests**
...
- [x] **Step 2: Write failing scrape-order and cache-hit tests**
...
- [x] **Step 3: Implement the focused Stage 1B runner**
...
- [x] **Step 4: Merge cached validations in `scoreAll`**
...
- [x] **Step 5: Put Stage 1B before Stage 2 in both paid flows**
...
- [x] **Step 6: Make profile changes cache-aware and provider-free**
...
- [x] **Step 7: Run server integration and race tests**
...
- [x] **Step 1: Write failing view-model and escaping tests**
...
- [x] **Step 2: Build the narrow view model**
...
- [x] **Step 3: Add and reuse the template partial**
...
- [x] **Step 4: Add semantic danger styling and restore row contrast**
...
- [x] **Step 6: Perform Tier C browser QA with `/browse`**
...
- Archived specification:
  `260718-stage-1-contextual-dealbreaker-validation-and-exclusion-evidence.md`
- Archived implementation plan:
  `260718-stage-1-contextual-dealbreaker-validation-and-exclusion-evidence-plan.md`
...
- [x] **Step 2: Run the explicit live-provider gate**
...
- [x] **Step 3: Re-run the complete browser journey on the candidate commit**
...
- [x] **Step 5: Archive the completed spec and plan**

Create one dated workstream directory:

```text
docs/archive/2026-07-18-contextual-dealbreaker-validation/
```
...
`docs/README.md`. Do not copy raw logs, secrets, or unsanitized screenshots into Git.

- [x] **Step 6: Run the documentation publication gate and commit**
...
awk '/^[[:space:]]*\|/ && length($0) > 100 { \
  ...
  docs/archive/2026-07-18-contextual-dealbreaker-validation/*.md
git add docs
git diff --cached --check
git diff --cached
gitleaks git --staged --redact --no-banner
...
- [x] **Step 7: Inspect the cumulative candidate**
...
- [x] **Step 8: Close Gas Town bookkeeping without remote submission**
