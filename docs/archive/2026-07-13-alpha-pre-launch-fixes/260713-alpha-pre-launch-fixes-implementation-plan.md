...
| docs/README.md | Index this plan while active, then retain only the human launch checklist after implementation. |
...
**Files:**
- Create: docs/archive/2026-07-13-alpha-pre-launch-fixes/260713-alpha-pre-launch-fixes-verification.md
- Move: docs/specs/260713-alpha-pre-launch-fixes.md
- Move: docs/plans/260713-alpha-pre-launch-fixes-implementation-plan.md
- Modify: docs/specs/260713-alpha-launch-human-blocked-steps.md
...
~~~sh
mkdir -p docs/archive/2026-07-13-alpha-pre-launch-fixes
git mv \
  docs/specs/260713-alpha-pre-launch-fixes.md \
  docs/archive/2026-07-13-alpha-pre-launch-fixes/260713-alpha-pre-launch-fixes.md
git mv \
  docs/plans/260713-alpha-pre-launch-fixes-implementation-plan.md \
  docs/archive/2026-07-13-alpha-pre-launch-fixes/260713-alpha-pre-launch-fixes-implementation-plan.md
~~~
...
Update docs/README.md so Active Work contains only:

~~~markdown
- [First production launch human-blocked steps](../2026-07-26-first-production-launch-human-blocked-steps/260716-first-production-launch-human-blocked-steps.md)
~~~
...
git add \
  docs/README.md \
  docs/README.md \
  docs/specs/260713-alpha-launch-human-blocked-steps.md \
  docs/archive/2026-07-13-alpha-pre-launch-fixes
git diff --cached --check
git diff --cached
gitleaks git --staged --redact --no-banner --no-color
~~~
