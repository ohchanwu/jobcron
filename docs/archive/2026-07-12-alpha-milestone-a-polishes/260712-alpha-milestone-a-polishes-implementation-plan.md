...
- Create `docs/archive/2026-07-12-alpha-milestone-a-polishes/260712-alpha-milestone-a-polishes-verification.md`: final test and browser evidence.
- Modify `docs/README.md`: keep active links correct during implementation, then point to archived records after completion.
...
- Create: `docs/archive/2026-07-12-alpha-milestone-a-polishes/260712-alpha-milestone-a-polishes-verification.md`
- Move after verification: `docs/specs/260712-alpha-milestone-a-polishes.md`
- Move after verification: `docs/plans/260712-alpha-milestone-a-polishes-implementation-plan.md`
...
Create `docs/archive/2026-07-12-alpha-milestone-a-polishes/260712-alpha-milestone-a-polishes-verification.md` with:
...
```bash
mkdir -p docs/archive/2026-07-12-alpha-milestone-a-polishes
git mv docs/specs/260712-alpha-milestone-a-polishes.md docs/archive/2026-07-12-alpha-milestone-a-polishes/
git mv docs/plans/260712-alpha-milestone-a-polishes-implementation-plan.md docs/archive/2026-07-12-alpha-milestone-a-polishes/
```

Change `docs/README.md` so `Active Work` says `None.` and `Recently Archived` links to the archived spec, implementation plan, and verification report. Replace the active-plan link in `docs/README.md` with a link to the archived verification report.
...
git diff HEAD~5 -- internal/server web docs
git status --short
```
...
```bash
git add docs/README.md docs/README.md docs/archive/2026-07-12-alpha-milestone-a-polishes
