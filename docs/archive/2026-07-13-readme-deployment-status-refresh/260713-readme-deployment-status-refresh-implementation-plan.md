...
**Files:**
- Move: `docs/specs/260713-readme-deployment-status-refresh.md`
- Move: `docs/plans/260713-readme-deployment-status-refresh-implementation-plan.md`
...
```text
docs/archive/2026-07-13-readme-deployment-status-refresh/
```

Set `docs/README.md` Active Work to `None.` and add both records under
Recently Archived.
